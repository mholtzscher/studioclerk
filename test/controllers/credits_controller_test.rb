...
#       post credits_url, params: { credit: { notes: @credit.notes, amount: @credit.amount, credit: @credit.credit, date_time: @credit.date_time } }
#     end
...
#     patch credit_url(@credit), params: { credit: { notes: @credit.notes, amount: @credit.amount, credit: @credit.credit, date_time: @credit.date_time } }
